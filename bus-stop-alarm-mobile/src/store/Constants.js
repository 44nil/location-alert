// ============================================================
// Constants.js — Global Data Store
// ============================================================
...
// Mutable array to hold active POIs. Exporting the array reference.
export const STOPS = [];

// Generate stop objects for all cities
export function getAllCityStops() {
    return Object.entries(CITIES).map(([city, coord]) => ({
        id: city,
        name: city,
        city: city,
        lat: coord.lat,
...
// Function to update STOPS array when new searches happen
export function resetStops(newStops) {
    STOPS.length = 0;
    STOPS.push(...newStops);
}
